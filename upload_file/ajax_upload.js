...
var upload_controller = 'upload.php?block_id=';
var blockLength = 1048576; // 1024 kb
...
var sendFile = function (blockLength) {
    ...
    sendNextChunk = function () {
        ...
        jqxhr = $.ajax({
            async: true,
            url: (upload_controller+incrimentalIdentifier),
            data: fileChunk,
            cache: false,
            contentType: false,
            processData: false,
            ...
            success: function (notice) {
                // assume that every chunck is success
                if(incrimentalIdentifier == uploader.totalBlocks){
...
function startUpload(fileElementId, uploadProgressElement, statusLabel, uploadButton, cancelButton) {
